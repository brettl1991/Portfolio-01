  ...
  return (
    <S.BackgroundStyle>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="125" cy="125" r="75" stroke="#3CE5FC" strokeWidth="3" />
        <path
          id="ring2"
      ...
      >
        ...
        <g filter="url(#filter1_f_18_198)">
          <circle cx="125" cy="125" r="40" stroke="#FF8997" strokeWidth="3" />
        </g>
        <circle cx="125" cy="125" r="35" stroke="#3DE4FC" strokeWidth="3" />
        <defs>
          <filter
            id="filter0_f_18_198"
            x="0"
